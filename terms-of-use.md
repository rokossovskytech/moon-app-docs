...
- If you are under 18, you must have the **consent of a parent or guardian**.  
...
- Use it only for **lawful and personal purposes**.  
- Not copy, reverse-engineer, decompile, or modify the App.  
- Not interfere with its functionality, integrity, or security.  

You are responsible for maintaining the security of your device and any data stored within the App.

---

## 4. Health and AI Disclaimer
Moon App provides **informational insights only** and is **not a medical device**.  
...
**Moon AI responses** are generated by artificial intelligence and are for general informational purposes only. AI-generated advice should not be considered as professional medical guidance.
...
All trademarks, content, designs, icons, and code within Moon App are the **intellectual property of Roman Mahda**.  
...
Any disputes arising under or related to these Terms will be resolved under **Ukrainian jurisdiction**.
